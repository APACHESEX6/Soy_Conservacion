...
const FloraGroups: SpeciesGroup[] = [
    { label: "Plantas",  icon: Leaf,             tone: "bg-green-500/10 text-green-700 ring-green-500/20",   ring: "ring-green-500",  count: 84 },
    { label: "Hongos",   icon: MushroomIcon,     tone: "bg-amber-500/10 text-amber-700 ring-amber-500/20",   ring: "ring-amber-500",  count: 37 },
];  

...
const SHIMMER_LABEL_STYLE: React.CSSProperties = {
  background:
    "linear-gradient(90deg, rgba(15,23,42,0.32) 0%, rgba(15,23,42,0.48) 38%, rgba(99,102,241,0.72) 50%, rgba(15,23,42,0.48) 62%, rgba(15,23,42,0.32) 100%)",
  ...
  useEffect(() => {
    ...
    const loadGroups = async () => {
      try {
        ...
        const faunaGroups = backendGroups.filter((g) => {
    ...
    >
      ...
      <div className="flex flex-col px-5 pt-3 pb-3 shrink-0">
          ...
          <div className="flex items-center gap-4">
            ...
            <div
              ...
              style={{
                ...
                boxShadow: "0 2px 6px rgba(99,102,241,0.3), 0 8px 24px rgba(99,102,241,0.25)",
              }}
            >
              <PawPrint className="h-icon-lg w-icon-lg" strokeWidth={2.2} />
            </div>
              ...
              <div key={id} className="py-[3px]">
                <button
                  ...
                  className={`source-chip-button group relative flex w-full min-w-0 items-center justify-center gap-1.5 rounded-2xl px-2 py-2.5
                    ...
                    ${
                      isActive
                        ? "source-chip-active-indigo active:brightness-[0.97]"
        ...
        >
          ...
          <div className="flex flex-col">
            ...
            <p
              ...
              style={{
                background:
                  "linear-gradient(90deg, #1e293b 0%, #334155 25%, #6366f1 50%, #334155 75%, #1e293b 100%)",
                backgroundSize: "200% auto",
                WebkitBackgroundClip: "text",
                backgroundClip: "text",
                WebkitTextFillColor: "transparent",
        ...
        <div
          ...
          style={{
            background:
              "linear-gradient(90deg, transparent 0%, rgba(99,102,241,0.15) 30%, rgba(99,102,241,0.15) 70%, transparent 100%)",
          }}
        />
      ...
      <div
        ...
        style={{
          ...
          paddingTop: "4px",
          paddingBottom: "0px",
          ["--card-glow-rgb" as string]: "99, 102, 241",
        }}
      >
        <div className="flex flex-col gap-7 pt-0 pb-2">
          {groups.map((group) => {
            ...
            return (
              <button
                ...
                className={`fauna-card group relative flex w-full items-center gap-3.5 rounded-[22px] p-3 text-left focus-visible:outline-none ${
                  isSelected ? "" : "focus-visible:ring-2 focus-visible:ring-indigo-400/60"
                }`}
                ...
                style={{
                  ...(isSelected
                    ? {
                        background:
                          "linear-gradient(145deg, rgba(255,255,255,0.98) 0%, rgba(250,250,255,0.95) 100%)",
                        boxShadow: `
                        0 0 0 2px ${group.hex},

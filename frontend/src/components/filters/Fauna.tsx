...
const faunaGroups: faunaGroup[] = [
    { label: "Aves",       icon: Bird,           tone: "bg-sky-500/10 text-sky-600 ring-sky-500/20",             ring: "ring-sky-500",     count: 67 },
    { label: "Mamíferos",  icon: Rabbit,         tone: "bg-orange-500/10 text-orange-700 ring-orange-500/20",    ring: "ring-orange-500",  count: 42 },
    { label: "Reptiles",   icon: ChameleonIcon,  tone: "bg-amber-600/10 text-amber-700 ring-amber-600/20",       ring: "ring-amber-500",   count: 19 },
    { label: "Peces",      icon: Fish,           tone: "bg-blue-500/10 text-blue-700 ring-blue-500/20",          ring: "ring-blue-500",    count: 14 },
    { label: "Aracnidos",  icon: SpiderIcon,     tone: "bg-red-500/10 text-red-700 ring-red-500/20",             ring: "ring-red-500",     count: 31 },
    { label: "Anfibios",   icon: FrogIcon,       tone: "bg-emerald-500/10 text-emerald-700 ring-emerald-500/20", ring: "ring-emerald-500", count: 28 },
    { label: "Moluscos",   icon: SnailIcon,      tone: "bg-purple-500/10 text-purple-700 ring-purple-500/20",    ring: "ring-purple-500",  count: 12 },
    { label: "Animalia",   icon: PawPrint,       tone: "bg-green-500/10 text-green-700 ring-green-500/20",       ring: "ring-green-500",    count: 9  },
];
		...
		<section className="flex h-full flex-col gap-3 overflow-hidden">
			...
			<div className="flex flex-col gap-2">
				...
				<div className="flex items-center justify-between">
					<span className="text-sm font-semibold text-[#003B46]">
						Filtrar Fauna
					</span>
